      ...
      <article>
        <section className="tcontainer mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-base sm:text-lg lg:text-xl my-4">
            ...
            donations, we strive to ensure that everyone has access to essential
            resources. Whether it&apos;s disaster relief efforts, community
            outreach, or long-term projects, we are dedicated to making a
            meaningful difference. Together, we can create a brighter, more
